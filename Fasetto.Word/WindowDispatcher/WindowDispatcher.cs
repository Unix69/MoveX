            ...
            mLooper = new Thread(() =>
            {
                ...
                switch (type)
                {
                    case YesNoRequest:
                        ...
                        Sync.TryGetValue(Id, out ManualResetEvent YesNoResponseAvailability);
                        ...
                        {
                            var w = new YesNoWindow(YesNoResponseAvailability, message, response);
                            mWindows.Push(w);
                            w.Show();
                    ...
                    case WhereRequest:
                        ...
                        Sync.TryGetValue(Id, out ManualResetEvent WhereResponseAvailability);
                        ...
                        {
                            var w = new WhereWindow(WhereResponseAvailability, whereMessage, whereResponse);
                            mWindows.Push(w);
                            w.Show();
                            System.Windows.Threading.Dispatcher.Run();
                        });
