...
namespace Movex.MessageView
{
    ...
    public class WindowViewModel : BaseViewModel
    {
        ...
        /// </summary>
        private ManualResetEvent mCloseWindowEvent = null;
        ...
        public WindowViewModel(Window window)
        {
            ...
            IoC.Message.SetWindowContainer(mWindow);
        ...
        /// <summary>
        /// Set the CloseWindowEvent Handler
        /// </summary>
        /// <param name="handle"></param>
        public void SetCloseWindowEvent(ManualResetEvent handle)
        {
            mCloseWindowEvent = handle;
        }

        /// <summary>
        /// Close the Window in a custom way
        /// </summary>
        private void CloseWindow()
        {
            ...
            // Signal to the calling thread (if any) that the Window has been closed
            if (mCloseWindowEvent != null)
                mCloseWindowEvent.Set();
        }
